...
#define D_MURPHY   0x000000400	/**< Debug the iRODS module in Parrot. */
...
#define D_REMOTE   (D_HTTP|D_FTP|D_NEST|D_CHIRP|D_DCAP|D_RFIO|D_LFC|D_GFAL|D_MULTI|D_GROW|D_HDFS|D_BXGRID|D_XROOTD)
